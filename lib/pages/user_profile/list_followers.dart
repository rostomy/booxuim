...
class ListFollowersAndSubscriptions extends StatelessWidget {
  final String id;
  final String type;

  const ListFollowersAndSubscriptions({Key key, this.id, this.type})
      : super(key: key);
  ...
  UserEvent getEvent() {
    if (type == "followers") {
      return UserEvent.getUserFollowers(id,
      ...
      return UserEvent.getUserSubscriptions(id,
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MDY3YTkwYzJiZTNhYTViNjAzNzhlNmEiLCJ1c2VybmFtZSI6Im5hbWUyIiwiaWF0IjoxNjI0MDEwOTU0fQ.dLNraEJv-I1_tC_GxUFNQ9P_3VQXV2Pm0EntxafEXqE");
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: BlocProvider(
          create: (context) => getIt<UserBloc>()..add(getEvent()),
