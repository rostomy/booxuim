...
class _PostWidgetState extends State<PostWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => _postBloc = getIt<PostBloc>(),
      child: BlocConsumer<PostBloc, PostState>(builder: (context, state) {
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontWeight: FontWeight.w500,
                      color: widget.postFeed.book != null
                          ? Colors.blue
                          : Colors.black,
                    ),
                  ),
                            ...
                            BlocProvider.value(
                              ...
                              child: IconButton(
                                  icon: Icon(
                                    ...
                                    color:
                                        _liked ? Colors.red : Color(0XFF3A4056),
                                  ),
                                  onPressed: () {
                                    _postBloc
                                      ..add(PostEvent.likePost(
                                          widget.postFeed.id,
        ...
        return state.sharePostFailureOrSuccessOption.fold(() => null,
            (a) => a.fold((l) => null, (r) => print("post shared ${r}")));
      }),
    );
  }
}
